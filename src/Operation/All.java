...
public class All{
    ...
    public static void data(String username) throws IOException, InterruptedException {
        ...
        if(m==1){
            ...
            System.out.println("\t\t\t\t\tThank you for visiting our Blogging web");
            System.exit(0);
        }
...
//        }
    ...
    public static void profile(String username) throws IOException {
        ...
        for(int i=0;i<s.size();i=i+8){
            if(s.get(i).equals(username)){
                ...
                System.out.println(tab+"\tFirst Name    : "+s.get(i+1));
                System.out.println(tab+"\tLast Name     : "+s.get(i+2));
    ...
    public static void profile2(String username) throws IOException {
        List<String> s= new ArrayList<>();
        Scanner scan2=new Scanner(System.in);
...
//                System.out.println("Option: ");
    ...
    public static void mainPage() throws IOException, InterruptedException {
        ...
        System.out.println(tab+"\t===========================             ===========================");
        System.out.println();
        System.out.println(tab+"\t**\t1..User Panel    **             ||  1>>Ridowan Ul Alam   || ");
        System.out.println(tab+"\t**\t2..Admin Panel   **             ||  2>>Nafis Fuad Nirob  ||");
        System.out.println(tab+"\t===========================             ||  3>>Sharmin Tabassum  || ");
        System.out.print(tab+"Choose an option: ");
        int n=scan.nextInt();
